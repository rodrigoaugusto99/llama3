...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<OllamaService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockOllamaService getAndRegisterOllamaService() {
  _removeRegistrationIfExists<OllamaService>();
  final service = MockOllamaService();
  locator.registerSingleton<OllamaService>(service);
  return service;
}
// @stacked-mock-create
